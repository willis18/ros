...
class imu_odom :
    def __init__(self):
        ...
        while not rospy.is_shutdown():
            ...
            if self.is_imu == True and self.is_speed == True:
                ...
                br.sendTransform((self.odom_msg.pose.pose.position.x, self.odom_msg.pose.pose.position.y,
                 self.odom_msg.pose.pose.position.z), quaternion, rospy.Time.now(), "base_link", "odom")
            rate.sleep()
    ...
    def imu_callback(self, msg):
        #imu_quaternion = (msg.orientation.z)
